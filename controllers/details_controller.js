...
module.exports.logDetails= async  function(req,res){
    ...
    //  console.log(syear,smonth,sdate,shour,smin,ssec);
    //  console.log(eyear,emonth,edate,ehour,emin,esec);
...
// // console.log(syear,smonth,sdate,shour,smin);
// // console.log(eyear,emonth,edate,ehour,emin);
// // console.log(dyear,dmonth,ddate,dhour,);
//         //console.log(files);
...
if(min==emin && sec>esec)continue;
    ...
    message.push(msg);
        // console.log(min,sec,myArray[0],msg);
...
//   // console.log("THIS IS MY LIST :  ", messagesList);
//   return messages;
// }
